...
{
	print("\n--------------------------------------");
	print(" Targets system - Private200 Exited()");
	print("--------------------------------------\n");
	return 1;
}
...
{
	SendClientMessage(playerid, -1, "Welcome to the server!");
	return 1;
}

public OnPlayerRequestClass(playerid, classid)
{
	SetSpawnInfo(playerid, NO_TEAM, 0, 302.292877,-143.139099,1004.062500, 0.0, 0, 0, 0, 0, 0, 0);
